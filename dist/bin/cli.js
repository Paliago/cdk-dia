...
const rendering = __importStar(require("../src/render/index"));
async function initCli() {
    return (0, yargs_1.default)(process.argv.slice(2)).options({
        ...
        'rendering': { type: 'string', choices: [cdk_dia_1.Renderers.GRAPHVIZ, cdk_dia_1.Renderers.CYTOSCAPE], default: cdk_dia_1.Renderers.GRAPHVIZ, describe: 'The rendering engine to use' }
    }).version(false).argv;
}
