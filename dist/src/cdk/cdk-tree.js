...
})(ConstructInfoFqnType || (exports.ConstructInfoFqnType = ConstructInfoFqnType = {}));
...
class Node {
    ...
    shouldBeIgnored() {
        if (this.metadata) {
            ...
            if (infoAnnotations && Array.isArray(infoAnnotations)) {
                return infoAnnotations.some(annotation => typeof annotation === "string" && annotation === "cdk-dia:ignore");
            }
        }
    ...
    static fromObject(object) {
        ...
        if (object['metadata'] != undefined) {
            ...
            for (const metaKey in object['metadata']) {
